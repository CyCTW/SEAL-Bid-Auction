...
const init_schnorr_group =  async () => {
    ...
    const p = 5145502063699177093454710178259127921091715285626684965595631083932239806201n;
    const h = 653219150466924647793780487640641701902051287698290240683401509111697752952n;
    const g = 2247381610195599257003531654104927070502769275382448717372496680665253704287n;
